...
public class DayFragment  extends Fragment {
    ...
    public Cartesian createColumnChart(){
        ...
        TreeMap<String,Integer> graph_map = new TreeMap<String,Integer>();    // The treemap is used for sorting purposes.
        for(int i = 0; i < 4; i++){
            graph_map.put(current_time, 0);
        }
        ...
        //***** Create and fill column chart using AnyChart library *********/
        ...
        //Modifying properties of tooltip (when the finger is over the column / clicking it)
        column.tooltip()
                .titleFormat("At hour: {%X}")
                .format("{%Value}{groupsSeparator: } Steps")
                .anchor(Anchor.RIGHT_TOP);  // Respect to the pointer of the user. (Right of the finger)

        // TODO 5: Modify column chart tooltip properties
        column.tooltip()
                .position(Position.RIGHT_TOP) // Respect to the column (Right of the column)
                .offsetX(0d)
                .offsetY(5);
